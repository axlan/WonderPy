...
class MyTestCase(unittest.TestCase):
    ...
    def test_sketch_kit(self):
        ...
        self.assertAlmostEqual(m.call_args_list[0][0][0]['202']['degree'],
                                -WWCommandAccessory.SKETCH_PEN_DN_DEGREES_TLT)
        self.assertAlmostEqual(m.call_args_list[1][0][0]['203']['degree'],
                                 WWCommandAccessory.SKETCH_PEN_DN_DEGREES_PAN)
        self.assertAlmostEqual(m.call_args_list[2][0][0]['214']['prcnt' ],
                                -WWCommandAccessory.SKETCH_PEN_UP_VOLTAGE_TLT)
        self.assertAlmostEqual(m.call_args_list[3][0][0]['213']['prcnt' ],
    ...
    def test_launcher(self):
        ...
        self.assertAlmostEqual(m.call_args_list[0][0][0]['400']['cm_s'],  0.3)
        self.assertAlmostEqual(m.call_args_list[1][0][0]['401']['dir' ],  0  )
        self.assertAlmostEqual(m.call_args_list[2][0][0]['401']['dir' ],  1  )
