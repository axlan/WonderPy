...
class WWMedia:
    ...
    class WWSound:
        ...
        class WWSoundDashUpdated:
            # Pulled from firmware files. 177 sounds for US AN_DASH. Some still don't seem to work.
            # Could probably write test to check if sound is busy flag is triggered for each one.
            #Dash
            ALRIGHT_03="SYSTALRIGHT_03"
            AREAWESOME="SYSTAREAWESOME"
            AWESOME="SYSTAWESOME"
            AWWW_04="SYSTAWWW_04"
            BING_BONG="SYSTBING_BONG"
            BIRTHDAY="SYSTBIRTHDAY"
            BLOW_KISS="SYSTBLOW_KISS"
            BO_OKAY_03="SYSTBO_OKAY_03"
            BO_V7_VARI="SYSTBO_V7_VARI"
            BO_V7_YAWN="SYSTBO_V7_YAWN"
            BRAGGING1A="SYSTBRAGGING1A"
            BREAKDOWN="SYSTBREAKDOWN"
            BURP="SYSTBURP"
            BWAHH="SYSTBWAHH"
            CHANGETIRE="SYSTCHANGETIRE"
            CHARGE_03="SYSTCHARGE_03"
            CHARGE_04="SYSTCHARGE_04"
            COMING="SYSTCOMING"
            CONFUSED_1="SYSTCONFUSED_1"
            CONFUSED_2="SYSTCONFUSED_2"
            CONFUSED_3="SYSTCONFUSED_3"
            CONFUSED_5="SYSTCONFUSED_5"
            CONFUSED_6="SYSTCONFUSED_6"
            CONFUSED_8="SYSTCONFUSED_8"
            COOL="SYSTCOOL"
            CURIOUS_04="SYSTCURIOUS_04"
            CURIOUS_05="SYSTCURIOUS_05"
            CURIOUS_06="SYSTCURIOUS_06"
            CYA="SYSTCYA"
            DASH_HI_VO="SYSTDASH_HI_VO"
            DASH_OKAY1="SYSTDASH_OKAY1"
            DASH_WHAA1="SYSTDASH_WHAA1"
            DASH_WOW_3="SYSTDASH_WOW_3"
            DBDELIVERY="SYSTDBDELIVERY"
            DOODAYDOO="SYSTDOODAYDOO"
            EXCITED_01="SYSTEXCITED_01"
            EXCITED_02="SYSTEXCITED_02"
            EXCITED_06="SYSTEXCITED_06"
            FANTASTIC="SYSTFANTASTIC"
            FORGET_IT="SYSTFORGET_IT"
            FXBOING="SYSTFXBOING"
            GIGGLE_03="SYSTGIGGLE_03"
            GOBBLE_001="SYSTGOBBLE_001"
            GOOD_ONE="SYSTGOOD_ONE"
            GOODBYE="SYSTGOODBYE"
            GOTTADOIT="SYSTGOTTADOIT"
            GROWL_11A="SYSTGROWL_11A"
            HAHAHOT="SYSTHAHAHOT"
            HAPPYLAUGH="SYSTHAPPYLAUGH"
            HAVINGFUN1="SYSTHAVINGFUN1"
            HEAVYOBJEC="SYSTHEAVYOBJEC"
            HELLOECHO2="SYSTHELLOECHO2"
            HELLOECHO3="SYSTHELLOECHO3"
            HELLOECHO="SYSTHELLOECHO"
            HELP_HELP="SYSTHELP_HELP"
            HEREICOME="SYSTHEREICOME"
            HEY_A="SYSTHEY_A"
            HEY_B="SYSTHEY_B"
            HEY_C="SYSTHEY_C"
            HMM_MAYBE="SYSTHMM_MAYBE"
            HMM_NO="SYSTHMM_NO"
            HOWDY="SYSTHOWDY"
            HOWSGOING="SYSTHOWSGOING"
            HUH_06="SYSTHUH_06"
            HUMPH="SYSTHUMPH"
            I_SEE="SYSTI_SEE"
            INPUTS="SYSTINPUTS"
            INTRESTING="SYSTINTRESTING"
            KISS="SYSTKISS"
            LETMESEE="SYSTLETMESEE"
            LETS_DO_IT="SYSTLETS_DO_IT"
            LETS_GO="SYSTLETS_GO"
            LETSGO_02="SYSTLETSGO_02"
            LETSGO_03="SYSTLETSGO_03"
            LOOK_THAT="SYSTLOOK_THAT"
            ME_SEE="SYSTME_SEE"
            NO_FEAR="SYSTNO_FEAR"
            NO_WAY="SYSTNO_WAY"
            NOT_GOOD="SYSTNOT_GOOD"
            NOTTHATONE="SYSTNOTTHATONE"
            OH_NO_UNH="SYSTOH_NO_UNH"
            OHH_06="SYSTOHH_06"
            OKALRIGHT1="SYSTOKALRIGHT1"
            OKAY_03="SYSTOKAY_03"
            ON_THE_WAY="SYSTON_THE_WAY"
            OOPS_02="SYSTOOPS_02"
            OOPS_03="SYSTOOPS_03"
            RASPBERRY="SYSTRASPBERRY"
            ROAR="SYSTROAR"
            SCARED_ME="SYSTSCARED_ME"
            SIGH_DASH="SYSTSIGH_DASH"
            SNORING="SYSTSNORING"
            SURPRISE02="SYSTSURPRISE02"
            TAH_DAH_01="SYSTTAH_DAH_01"
            THATS_COOL="SYSTTHATS_COOL"
            THATS_IT="SYSTTHATS_IT"
            TIRED_YAWN="SYSTTIRED_YAWN"
            TOODLE_OO="SYSTTOODLE_OO"
            TOODLES="SYSTTOODLES"
            TRACTOR_02="SYSTTRACTOR_02"
            TRDELIVERY="SYSTTRDELIVERY"
            UMMHMM_02="SYSTUMMHMM_02"
            V7_OHNO_09="SYSTV7_OHNO_09"
            V7GIGGLEI6="SYSTV7GIGGLEI6"
            VROOM="SYSTVROOM"
            WAYTOGO="SYSTWAYTOGO"
            WELL_OKAY="SYSTWELL_OKAY"
            WHASHORT="SYSTWHASHORT"
            WHAT_THE1="SYSTWHAT_THE1"
            WHATISTHAT="SYSTWHATISTHAT"
            WHEEYEEYEE="SYSTWHEEYEEYEE"
            WHISTLE_A="SYSTWHISTLE_A"
            WHISTLE_B="SYSTWHISTLE_B"
            WHUH_OH_20="SYSTWHUH_OH_20"
            WOAH_NO="SYSTWOAH_NO"
            WUH_HO_5="SYSTWUH_HO_5"
            YAH_02="SYSTYAH_02"
            YAHOO_02="SYSTYAHOO_02"
            YAUHHUH="SYSTYAUHHUH"
            YEEHAW="SYSTYEEHAW"
            YIPPEE_02="SYSTYIPPEE_02"
            YIPPEE="SYSTYIPPEE"

            # DashDot
            AIRPORTJET="SYSTAIRPORTJET"
            BELLRING="SYSTBELLRING"
            BOING="SYSTBOING"
            BOT_CUTE_0="SYSTBOT_CUTE_0"
            COW_MOO11A="SYSTCOW_MOO11A"
            CROCODILE="SYSTCROCODILE"
            DINOSAUR_3="SYSTDINOSAUR_3"
            DUCK_QUACK="SYSTDUCK_QUACK"
            ELEPHANT_0="SYSTELEPHANT_0"
            ENGINE_REV="SYSTENGINE_REV"
            FLATTIRE2A="SYSTFLATTIRE2A"
            FROGRIBBIT="SYSTFROGRIBBIT"
            FX_03_GOAT="SYSTFX_03_GOAT"
            FX_CAT_01="SYSTFX_CAT_01"
            FX_DOG_02="SYSTFX_DOG_02"
            FX_LION_01="SYSTFX_LION_01"
            HAPPY_HONK="SYSTHAPPY_HONK"
            HELICOPTER="SYSTHELICOPTER"
            HELLOSHIFT="SYSTHELLOSHIFT"
            HORSEWHIN2="SYSTHORSEWHIN2"
            HORSEWHIN3="SYSTHORSEWHIN3"
            LASERS="SYSTLASERS"
            NERVOUS_01="SYSTNERVOUS_01"
            NERVOUS_03="SYSTNERVOUS_03"
            NERVOUS_06="SYSTNERVOUS_06"
            NERVOUS_07="SYSTNERVOUS_07"
            NERVOUS_09="SYSTNERVOUS_09"
            NERVOUS_10="SYSTNERVOUS_10"
            OT_CUTE_03="SYSTOT_CUTE_03"
            OT_CUTE_04="SYSTOT_CUTE_04"
            PIGSNORT_2="SYSTPIGSNORT_2"
            REELWIND="SYSTREELWIND"
            ROBOT_01="SYSTROBOT_01"
            ROBOT_02="SYSTROBOT_02"
            ROBOT_03="SYSTROBOT_03"
            ROBOT_04="SYSTROBOT_04"
            ROBOT_05="SYSTROBOT_05"
            ROBOT_06="SYSTROBOT_06"
            ROBOT_07="SYSTROBOT_07"
            ROBOT_08="SYSTROBOT_08"
            ROOSTER_01="SYSTROOSTER_01"
            SHORTBOOST="SYSTSHORTBOOST"
            SONARPING="SYSTSONARPING"
            SPARK="SYSTSPARK"
            SPEEDBOOST="SYSTSPEEDBOOST"
            SPINOUT_01="SYSTSPINOUT_01"
            SPLASH="SYSTSPLASH"
            TIRESQUEAL="SYSTTIRESQUEAL"
            TRAIN_WHIS="SYSTTRAIN_WHIS"
            TRUCKHORN="SYSTTRUCKHORN"
            TRUMPET_01="SYSTTRUMPET_01"
            TUGBOAT_01="SYSTTUGBOAT_01"
            US_LIPBUZZ="SYSTUS_LIPBUZZ"
            WOLFHOWL="SYSTWOLFHOWL"
            X_SIREN_02="SYSTX_SIREN_02"
